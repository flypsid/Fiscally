...
Fiscally est une application web moderne de gestion financière construite avec Next.js 15, TypeScript, et Better Auth. Le projet implémente une architecture de sécurité multicouche avec validation Zod et internationalisation complète.
...
Le projet Fiscally est dans un état stable et prêt pour le développement des fonctionnalités métier principales.